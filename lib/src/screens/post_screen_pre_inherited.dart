...
class _PostScreenState extends State<PostScreen> {
  ...
  Widget build(BuildContext context) {
    return _InheritedPost(
        child: new _PostList(posts: _posts, createPost: _addPost) //create post
        //mau di pasing diinject dari construtor ke child di PostButton yaitu di onPressed:()=> {} //mau diganti dengan createPost()
        //ini gak bagus patern yg gak bagus!
...
class _InheritedPost extends StatelessWidget {
  final Widget
      child; //kalau di ecrae final di atas maka di construcotr pakai this
  _InheritedPost({@required this.child}); //construortnya
...
class _PostButton extends StatelessWidget {
  Widget build(BuildContext context) {
    return FloatingActionButton(
      ...
      onPressed: () => {}, //pangil func createPost ktika button press
      tooltip: 'Add Post',
    );
  }
}
